...
the source content — markitdown, docling, or markdown-passthrough, routed
by harness.adapters.parsing.router. Frozen dataclasses, matching
harness.core.types style.
"""
...
class NormalizedDocument:
    ...
    parser: str  # "markitdown" | "docling" | "markdown"
